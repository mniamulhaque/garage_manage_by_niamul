...
@section('body')
    ...
    <section class="py-1 " id="">
        <form action="{{route('spvs.store')}}" method="post" id="" enctype="multipart/form-data">
            @csrf
                        ...
                        <div class="col-md-12 table-responsive">
                            <table class="table  mt-3">
                                ...
                                <tr>
                                    ...
                                    <td style=""><input type="text" class="" name="parts_name[1]"></td>
...
@push('script')
    ...
    <script>
        ...
        $(document).on('click', '.plus', function () {
            ...
            '<td ><input type="text" class="" name="parts_name['+serialNumber+']"></td>' +
