...
@section('body')
    ...
    <section class="py-1 " id="">
        <form action="{{route('paperhistories.store')}}" method="post" id="" enctype="multipart/form-data">
            @csrf
                        ...
                        <div class="col-md-12 table-responsive">
                            <table class="table  mt-3">
                                ...
                                <tr>
                                    ...
                                    <td  style=""><input type="text" class="" name="date[1]" value="{{date('m/d/Y')}}"id="datepicker"></td>
                                    <td  style=""><input type="text" class="" name="tax_token[1]" value="{{date('m/d/Y')}}"id="datepicker2"></td>

                                    <td  style=""><input type="text" class="" name="tax_token_note[1]"></td>
                                    <td  style=""><input type="text" class="" name="fitness[1]" value="{{date('m/d/Y')}}"id="datepicker3"></td>
                                    <td  style=""><input type="text" class="" name="fitness_note[1]"></td>
                                    <td  style=""><input type="text" class="" name="milage[1]"></td>
                                    <td style=""><input type="text" class="" name="milage_note[1]"></td>
    ...
    <script>
        ...
        $(document).on('click', '.plus', function () {
            var tr = '<tr>'+
                ...
                '<td  style=""><input type="text" class="" name="date['+serialNumber+']" value="{{date('m/d/Y')}}"id="datepicker"></td>'+
                '<td  style=""><input type="text" class="" name="tax_token['+serialNumber+']" value="{{date('m/d/Y')}}"id="datepicker2"></td>'+

'<td  style=""><input type="text" class="" name="tax_token_note['+serialNumber+']"></td>'+
'<td  style=""><input type="text" class="" name="fitness['+serialNumber+']" value="{{date('m/d/Y')}}"id="datepicker3"></td>'+
'<td  style=""><input type="text" class="" name="fitness_note['+serialNumber+']"></td>'+
'<td  style=""><input type="text" class="" name="milage['+serialNumber+']"></td>'+
'<td  style=""><input type="text" class="" name="milage_note['+serialNumber+']"></td>'+
