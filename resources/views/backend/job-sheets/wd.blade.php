...
@section('body')
    ...
    <section class="py-1 " id="">
        <form action="{{route('wds.store')}}" method="post" id="" enctype="multipart/form-data">
            @csrf
                        ...
                        <div class="col-md-12 table-responsive">
                            <table class="table  mt-3">
                                ...
                                <tr>
                                    ...
                                    <td  style="">
                                        <textarea  class="me-5" name="wdes[1]" cols="50" rows="5"></textarea>
...
@push('script')
    ...
    <script>
        ...
        $(document).on('click', '.plus', function () {
            ...
            '<td><textarea  class="me-5" name="wdes['+serialNumber+']" cols="50" rows="5"></textarea></td>' +
