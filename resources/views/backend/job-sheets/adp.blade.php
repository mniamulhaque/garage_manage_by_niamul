...
@push('script')
    ...
    <script>
        ...
        $(document).on('click', '.plus', function () {
            ...
            '<td colspan="2" style=""><input type="text" class="" name="amount['+serialNumber+']"></td>'+
            '<td colspan="2" style=""><input type="text" class="" name="date['+serialNumber+']" id="datepicker" value="{{ date('m/d/Y') }}"></td>'+
