            ...
            <ul class="side-menu">
                ...
                <li class="slide">
                    ...
                    <ul class="slide-menu">
                        ...
                        <li><a href="{{ route('customers.index') }}" class="slide-item">List Customer</a></li>
                ...
                <li class="slide">
                    ...
                    <ul class="slide-menu">
                        ...
                        <li><a href="{{ route('vehicles.create') }}" class="slide-item">Add Vehicle</a></li>

                        <li><a href="{{ route('vehicles.index') }}" class="slide-item">Vehicle List</a></li>

                        <li><a href="{{ route('vehicle-types.index') }}" class="slide-item">Vehicle Type</a></li>

                        <li><a href="{{ route('vehicle-brands.index') }}" class="slide-item">Vehicle Brand</a></li>
                ...
                <li class="slide">
                    ...
                    <ul class="slide-menu">
                        ...
                        <li><a href="{{ route('invoices.create') }}" class="slide-item">Add Invoice</a></li>

                        <li><a href="{{ route('invoices.index') }}" class="slide-item">List Invoice</a></li>
                ...
                <li class="slide">
                    ...
                    <ul class="slide-menu">
                        ...
                        <li><a href="{{ route('job-sheets.create') }}" class="slide-item">Add Job Sheet</a></li>

                        <li><a href="{{ route('job-sheets.index') }}" class="slide-item">List Job Sheet</a></li>
